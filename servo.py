    ...
    def __init__(self, bus=0, address=0x40, freq=50, channel_configs=None):
        ...
        if channel_configs is None:
            self.channel_configs = {
                0: (0, 180, 120, 520),   # Шея: 180 градусов обычно хватает 120-520
                1: (0, 270, 120, 520),   # Плечо (270°): расширенный диапазон для мощных серв
                2: (0, 270, 120, 520),   # Плечо левое
                3: (0, 180, 120, 520),   # Наклон головы: сузим диапазон, чтобы не сломать крепление
                4: (0, 270, 120, 520),   # Поворот плеча П
                5: (0, 270, 120, 520)    # Поворот плеча Л
            }
        else:
