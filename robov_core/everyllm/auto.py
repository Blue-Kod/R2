...
MODEL_CAPABILITIES: dict[str, dict] = {
    ...
    "pollinations/openai": {"vision": False, "thinking": False, "configurable_thinking": False},
    "pollinations/openai-fast": {"vision": False, "thinking": False, "configurable_thinking": False},
    "anyprovider/openai": {"vision": False, "thinking": False, "configurable_thinking": False},
    "g4f.space/auto": {"vision": False, "thinking": False, "configurable_thinking": False},
    "yqcloud/gpt-4": {"vision": False, "thinking": False, "configurable_thinking": False},
    "perplexity/auto": {"vision": False, "thinking": False, "configurable_thinking": False},
    "perplexity/turbo": {"vision": False, "thinking": False, "configurable_thinking": False},
    "perplexity/gpt41": {"vision": False, "thinking": False, "configurable_thinking": False},
    "felo/chat": {"vision": False, "thinking": False, "configurable_thinking": False},
    "felo/search": {"vision": False, "thinking": False, "configurable_thinking": False},
    "wewordle/v3": {"vision": False, "thinking": False, "configurable_thinking": False},
    "wewordle/gpt-4o": {"vision": False, "thinking": False, "configurable_thinking": False},
    "cohere/command-r-plus": {"vision": False, "thinking": False, "configurable_thinking": False},
